...
def download_manifest(
    ...
    from py_target_id.utils.google import google_copy
    ...
    if create_subdirs:
        subdirs = ["h5map", "ArchRCells", "Stats", "ArchRCells_Malig", "SE_Malig", "AD_Malig", "Metadata"]
    ...
    required_cols = ["Cloud_h5map", "Cloud_Archr", "Cloud_Stats", 
                    "Cloud_Archr_Malig", "Cloud_SE_Malig", "Cloud_AD_Malig", "Cloud_Metadata"]
    ...
    if create_subdirs:
        ...
        manifest_copy['Local_AD_Malig'] = manifest_copy['Cloud_AD_Malig'].apply(
            lambda x: os.path.join(dest_dir, "AD_Malig", os.path.basename(str(x)))
        )
    ...
    file_types = {
        ...
        'ad_malig': {
            'cloud_files': manifest_copy['Cloud_AD_Malig'].tolist(),
            'local_files': manifest_copy['Local_AD_Malig'].tolist(),
            'subdir': 'AD_Malig'
        },
        'metadata': {
