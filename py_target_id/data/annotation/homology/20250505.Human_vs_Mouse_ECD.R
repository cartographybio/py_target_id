...
# Get Info
dtq <- readRDS("Human_ECD_8mer_DT.rds")
dtlib <- readRDS("Mouse_ECD_8mer_DT.rds")
...
final_result4$filtered_gene_names[final_result4$filtered_gene_names=="NA"] <- ""
...
saveRDS(out, "human_vs_mouse.8mer.20250505.rds")
